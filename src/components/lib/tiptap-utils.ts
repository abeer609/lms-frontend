...
export const handleImageUpload = async (
  ...
  formData.append("upload_preset", "lms-preset");

  try {
    const response = await axios.post(
      `https://api.cloudinary.com/v1_1/dyzfqvxbr/image/upload`,
      formData,
      {
    ...
    // Cloudinary returns a JSON object with many fields, including `secure_url`
